                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    <a href="#"><h4>Software Engineer CV</h4></a>
                                    <div class="links_locat d-flex align-items-center">
                                        <div class="location">
                                            <p> <i class="fa fa-calendar"></i> Created: 2023-09-13</p>
                                        </div>
                                        <div class="location">
                                            <p> <i class="fa fa-clock-o"></i> Last Updated: 2023-09-13</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="jobs_right">
                                <div class="apply_now">
                                    <a class="boxed-btn3" href="#">Edit</a>
                                    <a class="boxed-btn3" href="#">Delete</a>
                                </div>
                            </div>
                        </div>
                        <!-- End Sample CV Item -->
