            ...
            <div class="form-container">
                ...
                <form action="job_add" method="post" onsubmit="return validateForm()">
                    <div class="form-group">
                        ...
                        <input type="number" name="employerId" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="offerMin" step="0.01" required>
                    </div>

                    <div class="form-group">
                        <label>Maximum Salary</label>
                        <input type="number" name="offerMax" step="0.01" required>
                    </div>

                    <div class="form-group">
                        <label>Years of Experience</label>
                        <select name="numberExp" required>
