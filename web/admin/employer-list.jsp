...
<html lang="vi">
    ...
    .btn-success { border-color:#86efac; color:#166534; background:#fff; padding:8px 12px; border-radius:8px; font-size:13px; }
    .btn-success:hover { background:#dcfce7; }
    
    .container { width:100%; max-width:1880px; margin:18px auto; padding:0 16px; }
    ...
    thead th {
        ...
        background:#fafafa; white-space:normal; word-wrap:break-word; overflow-wrap:anywhere;
        font-weight:700;
    }
    tbody td {
        padding:14px 16px; border-bottom:1px solid #f0f2f5; vertical-align:middle; white-space:normal;
        word-wrap:break-word; overflow-wrap:anywhere;
    }
    tbody tr:hover { background:#fafafa; }

    .col-id { width:4%; font-variant-numeric:tabular-nums; color:#374151; }
    .col-name { width:15%; font-weight:700; }
    ...
    .col-actions { width:15%; text-align:right; white-space:nowrap; }

    .badge { display:inline-block; padding:4px 8px; border-radius:999px; font-size:12px; font-weight:600; border:1px solid; }
