...
<div class="container">
    ...
    <div class="table-card">
        ...
        <div class="container">
                                ...
                                <c:forEach var="c" items="${candidates}">
                                    <tr>
                                        ...
                                        <td class="col-actions" style="text-align:right">
                                            ...
                                            <c:if test="${not empty bannedIds}">
                                                <c:forEach var="bid" items="${bannedIds}">
                                                    <c:if test="${bid == c.candidateId}">
                                            ...
                                            <c:choose>
                                                <c:when test="${isBanned}">
                                                    ...
                                                    <form method="post"
                                                          action="${pageContext.request.contextPath}/admin/candidates/unban"
                                                          style="display:inline"
                                                          onsubmit="return confirmUnban('${c.candidateName}');">
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <a class="btn"
                                                       href="${pageContext.request.contextPath}/admin/candidates/ban?id=${c.candidateId}&backTo=list">
                                                        Ban
                                                    </a>
                                                </c:otherwise>
                                            </c:choose>
            ...
            <script>
function confirmUnban(name){
  return confirm('Gỡ cấm ứng viên ' + (name || '') + ' khỏi trạng thái cấm?');
}
</script>
