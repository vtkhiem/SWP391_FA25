...
<head>
  ...
  <style>
    :root { --text:#0f172a; --muted:#64748b; --brand:#16a34a; --bg:#f8fafc; --header-h:96px; }
    *{box-sizing:border-box}
    ...
    main{ flex:1 0 auto; padding-top: calc(var(--header-h) + 24px); }
    .container{ max-width:860px; margin:0 auto; padding:0 16px 48px; }

    .category{ color:var(--brand); font-weight:700; text-transform:uppercase; font-size:12px; margin:6px 0 8px }
    h1{ font-size:32px; line-height:1.25; margin:0 0 10px }
    .meta{ font-size:13px; color:var(--muted); margin-bottom:16px; display:flex; gap:8px; align-items:center; flex-wrap:wrap }

    .cover{ width:100%; height:320px; object-fit:cover; border-radius:12px; margin:12px 0 20px; display:block }
    .content{ font-size:16px; line-height:1.75; color:#0f172a; }
    .content h2{ font-size:22px; margin:22px 0 8px }
