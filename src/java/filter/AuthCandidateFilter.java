...
@WebFilter(urlPatterns = {"/create-cv", "/delete-cv", "/edit-cv", "/list-cv", "/selectCV", "/applyJob", "/candidateProfile","/editCandidateProfile", "/uploadCandidateImage", "/viewApplyLog", "/filterApplyLog"})
