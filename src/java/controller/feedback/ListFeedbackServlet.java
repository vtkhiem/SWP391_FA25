 ...
 * @author vuthienkhiem
 */
@WebServlet(name = "ListFeedbackServlet", urlPatterns = {"/adminFeedback"})
        ...
        try {
            ...
            switch (role) {
                ...
                case "Employer":
                    ...
                    if (emp != null) {
                        feedbacks = dao.getFeedbackByEmployer(emp.getEmployerId());
                    }
                    break;

                case "Candidate":
                    Candidate can = (Candidate) session.getAttribute("user");
                    if (can != null) {
                        feedbacks = dao.getFeedbackByCandidate(can.getCandidateId());
                    }
                    break;
            ...
            e.printStackTrace();
            request.setAttribute("error", "Không thể tải danh sách phản hồi: " + e.getMessage());
